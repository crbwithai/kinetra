...
export default function CartDrawer() {
  ...
  return (
    <dialog
      ref={dialogRef}
      className="fixed inset-y-0 right-0 left-auto m-0 h-dvh w-full max-w-md border-none bg-bg-light p-lg text-bg-dark backdrop:bg-bg-dark/60 open:flex open:flex-col starting:translate-x-full motion-reduce:transition-none transition-transform duration-300"
    >
